...
/**
 * 外摘代码。引用自：
 * https://www.cnblogs.com/Cpart/p/7233848.html
 * 原作者：伟大的程序员2
 */
...
public class CRC16
{
	 ...
	 * @return CRC16校验值
	 */
	public static List<Byte> calcCrc16(byte[] data)
	{
	 ...
	 * @return CRC16校验值
	 */
	public static List<Byte> calcCrc16(byte[] data, int offset, int len)
	{
	 ...
	 * @return CRC16校验值
	 */
	public static List<Byte> calcCrc16(byte[] data, int offset, int len, int preval)
	{
		...
		/**
		 * 原代码：return ((ucCRCHi & 0x00ff) << 8) | (ucCRCLo & 0x00ff) & 0xffff;
		 */
		//符合动环规则
		List<Byte> res = new ArrayList<Byte>();
		res.add((byte) (ucCRCLo & 0x00ff));
		res.add((byte) (ucCRCHi & 0x00ff));
		return res;
	}
	...
	public static void main(String[] args)
	{
		...
		List<Byte> crc = CRC16.calcCrc16(new byte[] { 
				0x0, 0x0, 0x0, 0x48, 0x0, 0x2, 0x3c, (byte) 0xfd, 0x0, 0x0, 0x0, 0x65, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20
				});
